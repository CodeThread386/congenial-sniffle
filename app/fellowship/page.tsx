...
export default function CallForTutorials() {
    return (
        <main className="min-h-screen bg-[#03396c] relative text-white font-poppins selection:bg-white/20">
            ...
            <div className="relative z-10 pt-[150px] pb-20 px-4 md:px-10 max-w-[1360px] mx-auto flex flex-col">
                ...
                <div className="text-center mb-16">
                    <h1 className="text-3xl md:text-5xl font-bold mb-4">10th IEEE INTERNATIONAL TEST CONFERENCE INDIA 2026</h1>
                    <p className="text-xl md:text-2xl font-semibold text-yellow-400">JUL 19-21, 2026 | BENGALURU, INDIA</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        ...
                        <section className="bg-white/5 p-8 rounded-lg border border-white/10 backdrop-blur-sm">
                            <h3 className="text-2xl font-bold mb-6 border-b border-white/20 pb-2">Submission Guidelines</h3>
                            <ul className="list-disc list-outside ml-5 space-y-3 text-gray-200">
                                ...
                                <li>Submission link: <a href="https://easychair.org/my/conference?conf=itcindia2026" className="text-blue-300 hover:text-blue-100 underline break-all">https://easychair.org/my/conference?conf=itcindia2026</a></li>
                                <li><strong>The following details are mandatory:</strong>
                         ...
                         <section className="bg-white/5 p-8 rounded-lg border border-white/10 backdrop-blur-sm">
                            <h3 className="text-2xl font-bold mb-6 border-b border-white/20 pb-2">Call for Submission</h3>
                            <div className="space-y-4 text-gray-200 text-justify">
                                <p>
                                    ...
                                    devices, boards and systems—covering the complete cycle from design verification, design-for-test,
                                    design-for-manufacturing, silicon debug, manufacturing test, system test, diagnosis, reliability and
                                    failure analysis, and back to process and design improvement. At ITC India, design, test, and yield
                                    professionals can confront challenges faced by the industry, and learn how these challenges are
                                    being addressed by the combined efforts of academia, design tool and equipment suppliers,
                                    designers, and test engineers. This ITC India conference will be focusing on Test development in
                                    India, but the submissions may not be limited to topics related to this region. Topics related to
                                    design and test development across multi geographical regions will be of special interest.
                                </p>
                                <p>
                                    Authors are invited to submit original, high quality, practical and industry best practices as Tutorials
                                    describing recent work in the field of test and design.
                                </p>
                            </div>
                        </section>
                        ...
                        {/* Topics of Interest */}
                        <section className="bg-white/5 p-8 rounded-lg border border-white/10 backdrop-blur-sm">
                             <h3 className="text-2xl font-bold mb-6 border-b border-white/20 pb-2">Topics of Interest</h3>
                             <p className="mb-4 text-gray-300 italic">Include (not limited to):</p>
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        ...
                        <div className="bg-[#1a4b7c] p-6 rounded-lg border border-yellow-400/50 shadow-lg">
                            <h3 className="text-xl font-bold mb-4 text-yellow-400 border-b border-yellow-400/30 pb-2">Important Dates</h3>
                            <div className="space-y-4">
                                <div>
                                    <p className="text-xs text-gray-300 uppercase">Tutorial submission deadline</p>
                                    <p className="text-lg font-semibold">31st March, 2026</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-300 uppercase">Author notification</p>
                                    <p className="text-lg font-semibold">12th May, 2026</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-300 uppercase">Final manuscript due</p>
                        ...
                        <div className="bg-white/5 p-6 rounded-lg border border-white/10 backdrop-blur-sm text-sm text-gray-300">
                            ...
                            <div className="space-y-2">
                                ...
                                <p>
                                    ...
                                    <a href="mailto:itc-india-tpc@googlegroups.com" className="text-blue-300 hover:underline break-all">itc-india-tpc@googlegroups.com</a>
                                </p>
                                 <p>
                                    <span className="block text-xs uppercase text-gray-400">Tutorial Chair Email:</span>
                                    <a href="mailto:ITC-India-2026-Tutorials@easychair.org" className="text-blue-300 hover:underline break-all">ITC-India-2026-Tutorials@easychair.org</a>
                                </p>
                            </div>
                        </div>
